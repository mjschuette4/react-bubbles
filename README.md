...
`Tokens are used to encode authentication credentials and make them available in your local storage`

- [ ] What steps can you take in your web apps to keep your data secure?

`use https, encrypted tokens  stored in local storage, continually update your software`

- [ ] Describe how web servers work.

`basically when i person tries to go to a website they are making a request that the server takes and processes and returns the requested information in accordance with its programming`

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

`c => post, get, put, delete`
`R => read`
`U => update`
`D => delete`
